...
def modify_pytwin_logging(new_option: PyTwinLogOption = PyTwinLogOption.PYTWIN_LOGGING_OPT_FILE,
...
class _PyTwinSettings(object):
    ...
    def _initialize_wd():
        ...
        if _PyTwinSettings.MULTI_PROCESS_IS_ENABLED:
            pytwin_temp_dir = os.path.join(tempfile.gettempdir(),
                                           str(os.getpid()),
                                           _PyTwinSettings.WORKING_DIRECTORY_NAME)
        else:
            pytwin_temp_dir = os.path.join(tempfile.gettempdir(),
                                           _PyTwinSettings.WORKING_DIRECTORY_NAME)
