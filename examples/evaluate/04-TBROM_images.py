...
rom_directory_path = os.path.join(twin_model.tbrom_directory_path, rom_name)
snapshot = twin_model.get_snapshot_filepath(rom_name)
geometry = twin_model.get_geometry_filepath(rom_name)

temperature_file = snapshot_to_cfd(snapshot, geometry, "temperature", os.path.join(rom_directory_path, "cfd_file.ip"))
...
image_filepath = twin_model.get_image_filepath(
    rom_name, view_name
)  # img.imread(os.path.join(rom_directory_path, rom_name, "View1_0.000000.png"))
...
tui.display.save_picture(os.path.join(rom_directory_path, f"{view_name}_Fluent_0.000000.png"))
solver.exit()

image = img.imread(os.path.join(rom_directory_path, f"{view_name}_Fluent_0.000000.png"))
plt.imshow(image)
plt.show()
