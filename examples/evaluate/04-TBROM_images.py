...
in the 3D viewer enabled by PyFluent. For more information, see the `PyFluent-Visualization documentation <https://visualization.fluent.docs.pyansys.com>`_.
...
temperature_file = snapshot_to_cfd(snapshot,
                                   geometry,
                                   "temperature",
                                   os.path.join(rom_directory, "cfd_file.ip"))
