...
class TestTwinModel:
    ...
    def test_raised_errors_with_step_by_step_evaluation(self):
        ...
        try:
            ...
            assert "Initialize the evaluation" in str(e)
    ...
    def test_evaluation_initialization_with_config_file(self):
        ...
        assert "Provide the correct filepath to initialize the TwinModel object." in str(e)
    ...
    def test_raised_errors_with_tbrom_init(self):
        ...
        try:
            ...
            assert "Initialize evaluation" in str(e)
    ...
    def test_raised_errors_with_tbrom_bad_name(self):
        ...
        try:
            ...
            assert "Twin model does not include a TBROM named" in str(e)

        try:
            twin.get_geometry_filepath(rom_name="test")
        except TwinModelError as e:
            assert "Call the geometry file getter with a valid TBROM name." in str(e)

        try:
            twin.get_snapshot_filepath(rom_name="test")
        except TwinModelError as e:
            assert "Call the snapshot file getter with a valid TBROM name." in str(e)
    ...
    def test_raised_errors_with_tbrom_bad_view(self):
        ...
        with open(log_file, "r") as log:
            log_str = log.readlines()
        assert "Could not find the image file for given ROM name" in "".join(log_str)
